...
def body():
    ...
    t=Balloon(hm)    
    hm_icn=PhotoImage(file="C://Git_Projects//Student_Management_System//docs//Images//home_icon.png")
    ...
    icf=PhotoImage(file="C://Git_Projects//Student_Management_System//docs//Images//min1.png")
...
dweep''','Puducherry')
        ...
        ac_img = PhotoImage(file="C://Git_Projects//Student_Management_System//docs//Images//acc_image.png")
    ...
    acc=PhotoImage(file="C://Git_Projects//Student_Management_System//docs//Images//download - Copy.png")
    ...
    cal_logo=PhotoImage(file="C://Git_Projects//Student_Management_System//docs//Images//cal_logo.png")
    ...
    def exit_program():
        ...
        if ans1:
            ...
            win2.destroy()
            w.destroy()
    pwr=PhotoImage(file="C://Git_Projects//Student_Management_System//docs//Images//c1.png")
    ...
    def logout():
        ...
        if ans1:
            ...
            win1.destroy()
            win2.destroy()
    lg_out=PhotoImage(file="C://Git_Projects//Student_Management_System//docs//Images//pwrbtn.png")
...
image1=PhotoImage(file="C://Git_Projects//Student_Management_System//docs//Images//IMG-20220219-WA0002.png")
...
close=PhotoImage(file="C://Git_Projects//Student_Management_System//docs//Images//c1.png")
b3=Button(w, image=close, command=w.destroy,height=26,width=26,relief=SOLID,cursor='hand2')
b3.place(x=1235,y=20)

icf1=PhotoImage(file="C://Git_Projects//Student_Management_System//docs//Images//min1.png")
icf1b=Button(w, image=icf1, command=w.iconify,height=26,width=26,relief=SOLID,cursor='hand2')
icf1b.place(x=1235,y=60)

img=PhotoImage(file="C://Git_Projects//Student_Management_System//docs//Images//Presentation1.png")
